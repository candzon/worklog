					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center gap-3">
								<div class="display-6 text-body-secondary">404</div>
								<div>
									<h5 class="mb-1">Halaman Tidak Ditemukan</h5>
									<div class="text-body-secondary">Alamat yang Anda akses tidak tersedia.</div>
								</div>
							</div>
